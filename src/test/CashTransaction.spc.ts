...
describe('input and output sample validation check of cash transaction', () => {
    ...
    it('{ "date": "2016-01-07", "user_id": 1, "user_type": "juridical", "type": "cash_out", "operation": { "amount": 1000.00, "currency": "EUR" } } - 3.00', async ()=>{
        expect(await cashTransactionOperation({ "date": "2016-01-07", "user_id": 1, "user_type": "juridical", "type": "cash_out", "operation": { "amount": 1000.00, "currency": "EUR" } })).to.equal((3).toFixed(2))
    })

    it('{ "date": "2016-01-07", "user_id": 1, "user_type": "juridical", "type": "cash_out", "operation": { "amount": 100.00, "currency": "EUR" } } - 0.30', async ()=>{
        expect(await cashTransactionOperation({ "date": "2016-01-07", "user_id": 1, "user_type": "juridical", "type": "cash_out", "operation": { "amount": 100.00, "currency": "EUR" } })).to.equal((0.3).toFixed(2))
    })

    it('{ "date": "2016-01-10", "user_id": 1, "user_type": "juridical", "type": "cash_out", "operation": { "amount": 100.00, "currency": "EUR" } } - 0.30', async ()=>{
        expect(await cashTransactionOperation({ "date": "2016-01-10", "user_id": 1, "user_type": "juridical", "type": "cash_out", "operation": { "amount": 100.00, "currency": "EUR" } })).to.equal((0.3).toFixed(2))
    })
